...
export default async function Page() {
    ...
    return (
        <main className="flex-1 max-w-175 min-h-screen border-x border-zinc-300 dark:border-zinc-800 bg-white/50 dark:bg-zinc-900/50 backdrop-blur-xl">
            {/* Tabs */}
            <div className="flex bg-white dark:bg-black gap-12 px-3 sm:px-6 py-6 border-b border-zinc-300 dark:border-zinc-800 pb-4 sticky md:top-0 top-15 z-60 sm:block hidden">
