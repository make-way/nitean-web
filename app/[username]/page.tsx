    ...
    <div className='animate-in fade-in space-y-6 duration-300'>
        ...
        <div className='rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md'>
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              <p className='text-lg font-semibold text-slate-900'>{format(new Date(user.createdAt), 'MMMM yyyy')}</p>
            </div>
          </div>
        </div>
        ...
        <div className='rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md'>
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              <p className='text-lg font-semibold text-slate-900'>{user._count.posts}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='rounded-xl border border-dashed border-slate-300 bg-slate-50/50 p-8 text-center'>
        <p className='text-slate-600'>
          ...
          <Link href={`/${username}/posts`} className='font-semibold text-blue-600 hover:text-blue-700 hover:underline'>
            {user.name}
          </Link>
        </p>
      </div>
