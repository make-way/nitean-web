...
export const metadata: Metadata = {
  ...
  keywords: ['Nitean', 'Technology articles', 'Web development', 'Programming', 'Design', 'Tech blog', 'Software engineering'],
  ...
  openGraph: {
    ...
    description: 'Explore daily articles about technology, development, design, and digital innovation on Nitean.',
    siteName: 'Nitean',
    locale: 'en_US',
    type: 'website',
  },
